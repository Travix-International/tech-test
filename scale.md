...
As mentioned in the solution we will use MongoDB for the data layer of the platform. This will allow for a highly scalable independant database layer which can be scaled horizontally via sharding. i.e. distributing the data across multiple machines. We should try to scale vertically first before we implment horizontal scaling.
